...
with open("Data/urls.txt",'r', encoding="utf-8") as urllist, open('Data/data.csv','w', encoding="utf-8") as outfile, open('Data/finals.csv','w', encoding="utf-8") as res:
    res.write("recent stars, recent rating, best seller ranking, link\n")
    ...
    for url in urllist.readlines():
            ...
            try:
                ...
                if data:
                    for r in data['reviews']:
                        ...
                        if len(list) == 10:
                            total -= list.pop(0)
                            if total <= 35 or len(data['reviews']) < 10:
                                i = 6
                                passed = False
                                break
        ...
        if passed:
            res.write(str(complete)+", "+str(complete/50)+", "+str(num)+", "+"https://www.amazon.com/dp/"+url[39:50]+"\n")
